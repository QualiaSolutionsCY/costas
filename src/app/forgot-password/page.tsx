      ...
      <div className="mx-auto w-full max-w-sm">
        <div className="mb-6 flex items-center gap-3">
          ...
          <div className="min-w-0">
            ...
            <p className="truncate text-xs text-muted">{t.forgotSubtitle}</p>
          </div>
        ...
        {state.ok ? (
          <div className="rounded-xl border bg-surface p-5 sm:p-6">
            <div className="rounded-lg bg-positive/10 px-4 py-3">
              <p className="text-sm font-semibold text-positive">{t.resetSent}</p>
              <p className="mt-1 text-xs text-muted">{t.resetSentSub}</p>
            </div>
          </div>
        ) : (
